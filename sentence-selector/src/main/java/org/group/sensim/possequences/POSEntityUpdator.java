...
public class POSEntityUpdator {
    ...
    public final static Logger log = LogManager.getLogger(POSEntityUpdator.class);
    ...
    public static void main(String[] args) throws MalformedURLException, FileNotFoundException, UnsupportedEncodingException {
        //String testFile = "./src/main/resources/org.group.sensim.eval/RSS-500.ttl";
        // String testFile = "./src/main/resources/org.group.sensim.eval/ReutersTest.ttl";
        // String testFile = "./src/main/resources/org.group.sensim.eval/oke-challenge2018-training.ttl";
        // String testFile = "./src/main/resources/org.group.sensim.eval/dbpedia-spotlight-nif.ttl";
...
//        PrintWriter writer = new PrintWriter("src/main/resources/possequences/marking_entityToPOS_oke-challenge2018.txt", "UTF-8");
        ...
        docs.forEach(basisDoc -> {
            ...
            log.info("Extracting POS tags from: [" + basisDoc.getText() + "] and writing them to a file.");
//            String posTags = posMarker.extractPOStags(basisDoc.getText());
//            log.info("POS Tags: [" + posTags + "]");

            String entityPos = posMarker.extractPOSofEntities(basisDoc.getText(), entities, writer);
        });
